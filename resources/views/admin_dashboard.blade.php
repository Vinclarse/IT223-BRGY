    ...
    <div class="container-fluid px-4 py-4">
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-md h-100" style="border-left: 4px solid #0c55c2ff !important;">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                <h6 class="text-muted text-uppercase small mb-2">Total Officials</h6>
                                <h2 class="fw-bold mb-0">{{ $totalOfficials ?? 0 }}</h2>
                    ...
                    <div class="card-footer bg-transparent border-0 pt-0">
                        <a href="{{ url('manageusers_admin') }}" class="text-decoration-none small">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <h2 class="fw-bold mb-0">{{ $totalResidents ?? 0 }}</h2>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <h2 class="fw-bold mb-0">{{ $totalComplaints ?? 0 }}</h2>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-md h-100" style="border-left: 4px solid #ffc107 !important;">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <h2 class="fw-bold mb-0">{{ $totalAnnouncements ?? 0 }}</h2>
                    ...
                    <div class="card-footer bg-transparent border-0 pt-0">
                        <a href="{{ url('website_management') }}" class="text-decoration-none small">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h3 class="fw-bold mb-1">{{ $dashboardStats['pendingResidents'] ?? 0 }}</h3>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h3 class="fw-bold mb-1">{{ $dashboardStats['inactiveUsers'] ?? 0 }}</h3>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h3 class="fw-bold mb-1">{{ $dashboardStats['activeAdmins'] ?? 0 }}</h3>
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-3">
                                <a href="{{ url('manageusers_admin') }}" class="btn btn-outline-primary w-100 py-3">
                                    <i class="bi bi-people fs-4 d-block mb-2"></i>
                                    Manage Users
                                </a>
                            </div>
                            <div class="col-md-3">
                                <a href="{{ url('website_management') }}" class="btn btn-outline-info w-100 py-3">
                                    <i class="bi bi-globe fs-4 d-block mb-2"></i>
                                    Website Management
                                </a>
                            </div>
                            <div class="col-md-3">
                                <a href="{{ url('system_settings') }}" class="btn btn-outline-success w-100 py-3">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-center mb-1">
                                                ...
                                                <div>
                                                    ...
                                                    <small class="text-muted d-block">User: {{ $activity->user_id ?? 'N/A' }} • IP: {{ $activity->id_address ?? 'N/A' }}</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span class="badge bg-{{ $dashboardStats['dbStatus']['badge'] ?? 'secondary' }}">
                                    {{ $dashboardStats['dbStatus']['label'] ?? 'Unknown' }}
                                </span>
                            </div>
                            <div class="progress" style="height: 8px;">
                                <div class="progress-bar bg-{{ $dashboardStats['dbStatus']['badge'] ?? 'secondary' }}" role="progressbar" style="width: {{ ($dashboardStats['dbStatus']['label'] ?? '') === 'Connected' ? 100 : 25 }}%"></div>
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="d-flex justify-content-between mb-2">
                                <span class="text-muted">Open Complaints</span>
                                <span class="badge bg-warning text-dark">{{ $dashboardStats['openComplaints'] ?? 0 }}</span>
                            </div>
                            <div class="progress" style="height: 8px;">
                                <div class="progress-bar bg-warning" role="progressbar" style="width: {{ min(100, ($dashboardStats['openComplaints'] ?? 0) * 5) }}%"></div>
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="d-flex justify-content-between mb-2">
                                <span class="text-muted">Server Load</span>
                                <span class="badge bg-info">{{ $dashboardStats['serverLoadPercent'] ?? 0 }}%</span>
                            </div>
                            <div class="progress" style="height: 8px;">
                                <div class="progress-bar bg-info" role="progressbar" style="width: {{ $dashboardStats['serverLoadPercent'] ?? 0 }}%"></div>
                            </div>
                        </div>
                            ...
                            <div class="row text-center">
                                <div class="col-6 mb-3">
                                    <div class="p-3 bg-light rounded">
                                        <h4 class="fw-bold mb-0 text-primary">{{ ($totalOfficials ?? 0) + ($totalResidents ?? 0) }}</h4>
                                        <small class="text-muted">Total Users</small>
                                    </div>
                                </div>
                                <div class="col-6 mb-3">
                                    <div class="p-3 bg-light rounded">
                                        <h4 class="fw-bold mb-0 text-danger">{{ $dashboardStats['openComplaints'] ?? 0 }}</h4>
