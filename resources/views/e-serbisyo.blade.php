        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{url('e-serbisyo')}}">E-Serbisyo</a></li>
            ...
            <div class="col-md-4">
                <div class="card border-primary service-card h-100">
                    <div class="card-body text-center">
                        ...
                        <a href="{{url('requestDocument')}}" class="btn btn-outline-navy w-100">Request Document</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card border-primary service-card h-100">
                    <div class="card-body text-center">
                        ...
                        <a href="{{url('requestDocument#Complaint')}}" class="btn btn-outline-navy w-100">Submit Complaint</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
    ...
    <section class="container mb-5">
        <div class="row mb-4">
            <div class="col-md-12 justify-content-center">
                <h3 class="fw-bold text-navy text-center">Recent Community Feedback</h3>
                <p class="text-secondary text-center">See what other residents are saying about our services</p>
            </div>
        </div>
