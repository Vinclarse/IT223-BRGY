        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{url('e-serbisyo_guest')}}">E-Serbisyo</a></li>
   ...
   <header class="container mb-4">
    ...
    <section class="container mb-5">
        <div class="row text-center mb-4">
            <div class="col">
                <h3 class="fw-bold text-navy">Why Use E-Serbisyo?</h3>
    ...
    <section class="container mb-5" id="services">
        <div class="row text-center mb-4">
            <div class="col">
                <h3 class="fw-bold text-navy">Our Services</h3>
            </div>
        </div>
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card border-primary h-100">
                    <div class="card-body">
                        ...
                        <a href="{{url('requestDocument')}}" class="btn btn-outline-navy btn-md d-flex justify-content-center">Request Document</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card border-primary h-100">
                    <div class="card-body">
                        ...
                        <a href="{{url('requestDocument#Complaint')}}" class="btn btn-outline-navy btn-md d-flex justify-content-center">File a Complaint</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card border-primary h-100">
                    <div class="card-body">
                        ...
                        <a href="{{url('requestDocument#Complaint')}}" class="btn btn-outline-navy btn-md d-flex justify-content-center"> Feedback</a>
                    </div>
                </div>
            </div>
        </div>
