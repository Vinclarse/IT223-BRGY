...
<body class="d-flex flex-column min-vh-100">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    @elseif($user['role'] === 'Official')
                        <li class="nav-item"><a class="nav-link" href="{{url('official_dashboard')}}">Home</a></li>
                    @elseif($user['role'] === 'Admin')
                        <li class="nav-item"><a class="nav-link" href="{{url('admin_dashboard')}}">Home</a></li>
                    @endif
                ...
                <div class="d-flex ms-2">
                    <a href="{{url('profile')}}"><i class="bi bi-person-circle fs-2 person text-white"></i></a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <header class="container mb-4 text-center">
        ...
        <p class="lead text-secondary">
            ...
            <span class="badge bg-info">{{ $user['role'] ?? 'Guest' }}</span>
        </p>
        
        <div class="container text-center">
            @if(!$editMode)
                <a href="{{ route('profile.edit') }}" class="btn btn-outline-navy mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @if($user['role'] === 'Admin' && $editMode)
                                            <input type="email" class="form-control" id="email" name="email" 
                                                value="{{ old('email', $userAccount->email ?? '') }}">
                                            @error('email')<div class="text-danger small">{{ $message }}</div>@enderror
                                        @else
                                            <input type="email" class="form-control" id="email" 
                                                value="{{ $userAccount->email ?? 'Not available' }}" readonly>
                                        @endif
                                    </div>
                                    ...
                                    @if($user['role'] === 'Resident')
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" 
                                                    value="{{ $userData->birth_date ? \Carbon\Carbon::parse($userData->birth_date)->format('F d, Y') : 'Not specified' }}" readonly>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label fw-bold">Gender</label>
                                                <input type="text" class="form-control" 
                                                    value="{{ $userData->sex ?? 'Not specified' }}" readonly>
                                            </div>
                                        </div>
                                        @else
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-control" id="sex" name="sex">
                                                    <option value="Male" {{ (old('sex', $userData->sex ?? '') == 'Male') ? 'selected' : '' }}>Male</option>
                                                    <option value="Female" {{ (old('sex', $userData->sex ?? '') == 'Female') ? 'selected' : '' }}>Female</option>
                                                </select>
                                ...
                                <div class="col-md-6">
                                    <!-- Contact Number -->
                                    @if(($user['role'] === 'Resident' || $user['role'] === 'Official') && isset($userData->contact_number))
                                    <div class="mb-3">
                                        <label for="contact_number" class="form-label fw-bold">Contact Number</label>
                                        <input type="text" class="form-control" id="contact_number" name="contact_number" 
                                            value="{{ old('contact_number', $userData->contact_number ?? '') }}" 
                                            {{ $editMode ? '' : 'readonly' }}>
                                    ...
                                    <!-- Address -->
                                    @if(($user['role'] === 'Resident' || $user['role'] === 'Official') && isset($userData->address))
                                    <div class="mb-3">
                                        <label for="address" class="form-label fw-bold">Address</label>
                                        <textarea class="form-control" id="address" name="address" rows="3" 
                                            {{ $editMode ? '' : 'readonly' }}>{{ old('address', $userData->address ?? '') }}</textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @else
                                            <input type="text" class="form-control" id="position" 
                                                value="{{ $userData->position ?? 'Barangay Official' }}" readonly>
                                        @endif
                                    </div>
                                    @endif
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @endphp
                                        <span class="badge {{ $statusClass }} p-2 d-block text-center">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" 
                                            value="{{ $userData->date_registered ? \Carbon\Carbon::parse($userData->date_registered)->format('F d, Y') : 'Not specified' }}" readonly>
                                    </div>
                                    @endif
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" 
                                            value="{{ $userAccount->date_created ? \Carbon\Carbon::parse($userAccount->date_created)->format('F d, Y') : 'Not specified' }}" readonly>
                                    </div>
                                    @endif
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="mb-3">
                    ...
                    @error('new_password_confirmation')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
                </div>
                    </div>
