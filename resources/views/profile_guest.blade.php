...
<body class="d-flex flex-column min-vh-100">
    ...
    <header class="container mb-4 text-center">
        <h1 class="display-5 fw-bold text-navy">Who's Logging In?</h1>
            ...
            <div class="container mb-5">
                <div class="row">
                    <div class="col-md-4">
                        <a href="{{url('login?role=Resident')}}" style="text-decoration: none; color: inherit;">
                            <div class="card">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('login?role=Official')}}" style="text-decoration: none; color: inherit;">
                            <div class="card">
                                <div class="card-body text-center">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('login?role=Admin')}}" style="text-decoration: none; color: inherit;">
                            <div class="card">
                                <div class="card-body text-center">
    ...
    <p class="lead text-secondary">
                Don't have an account? <a href="{{url('signup')}}" class="link-primary">Sign Up</a>
            </p>
