        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{url('transparency')}}">Transparency</a></li>
                ...
                <div class="d-flex ms-2">
                    <a href="{{('profile')}}"><i class="bi bi-person-circle fs-2 person" style="color: rgb(115, 115, 225);"></i></a>
                </div>
            </div>
        </div>
    </nav>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card h-100 shadow-sm border-0">
                                ...
                                <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                                    ...
                                    <span class="badge
                                        @if($report->category == 'Financial') bg-success
                                        @elseif($report->category == 'Project') bg-warning text-dark
                                        @elseif($report->category == 'Community') bg-info
                                        @else bg-secondary
                                        @endif
                                    ">
                                        {{ $report->category }}
