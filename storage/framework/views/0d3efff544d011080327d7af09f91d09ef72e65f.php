            ...
            <div class="col-lg-6">
                <div class="card shadow-sm h-100">
                    <div class="card-header bg-white border-0">
                        <h5 class="mb-0 fw-bold"><i class="bi bi-megaphone me-2"></i>Announcements</h5>
                    </div>
                    <div class="card-body">
                        <form class="row g-2 mb-3" method="POST" action="<?php echo e(route('announcements.store')); ?>">
                            ...
                            <div class="col-md-12 d-flex justify-content-end">
                                <button class="btn btn-primary btn-sm"><i class="bi bi-plus-lg"></i> Post</button>
                            </div>
                        </form>
                ...
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body">
                        <form class="row g-2 mb-3" method="POST" action="<?php echo e(route('events.store')); ?>">
                            ...
                            <div class="col-md-12 d-flex justify-content-end">
                                <button class="btn btn-primary btn-sm"><i class="bi bi-plus-lg"></i> Add Event</button>
                            </div>
                        </form>
    ...
    <section class="container mb-5">
        <div class="card shadow-sm">
            <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                <h5 class="mb-0 fw-bold"><i class="bi bi-file-earmark-text me-2"></i>Transparency Reports</h5>
                <a class="btn btn-outline-primary btn-sm" href="<?php echo e(route('transparency_records')); ?>">Open full manager</a>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-sm align-middle">
...
</html><?php /**PATH C:\Users\Gaan's Computer\Documents\Main Main file\resources\views/website_management.blade.php ENDPATH**/ ?>