...
<body class="d-flex flex-column min-vh-100">
    ...
    <header class="container mb-4">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="display-5 fw-bold">Welcome to Barangay Online Services and Public Information System</h1>
            ...
            <div class="col-md-4 text-center">
                <img src="<?php echo e(url('frontend/logo.png')); ?>" alt="Barangay Logo" width="180px" height="180px" class="img-fluid mb-3">
...
</html><?php /**PATH C:\Users\Gaan's Computer\Documents\Main Main file\resources\views/resident_dashboard.blade.php ENDPATH**/ ?>