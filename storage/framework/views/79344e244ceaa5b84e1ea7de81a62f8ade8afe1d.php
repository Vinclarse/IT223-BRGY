...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="<?php echo e(url('manageusers_admin')); ?>">Manage Users</a></li>
            ...
            <div class="col-md-3">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <h3 class="fw-bold mb-0 text-center"><?php echo e($counts['admins'] ?? 0); ?></h3>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <h3 class="fw-bold mb-0 text-center"><?php echo e($counts['officials'] ?? 0); ?></h3>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <h3 class="fw-bold mb-0 text-center"><?php echo e($counts['residents'] ?? 0); ?></h3>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <h3 class="fw-bold mb-0 text-center"><?php echo e($counts['pendingResidents'] ?? 0); ?></h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="container mb-5">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form class="row g-2 align-items-end mb-3" method="GET" action="<?php echo e(route('manageusers_admin')); ?>">
                    <div class="col-md-4">
                        <label class="form-label small text-muted">Search</label>
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" class="form-control" placeholder="Email or ID">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label small text-muted">Role</label>
                        <select name="role" class="form-select">
                            <option value="">All</option>
                            <?php $__currentLoopData = ['Admin','Official','Resident']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($role); ?>" <?php if(request('role')===$role): echo 'selected'; endif; ?>><?php echo e($role); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-2 d-flex gap-2">
                        ...
                        <a class="btn btn-outline-secondary w-100" href="<?php echo e(route('manageusers_admin')); ?>">Reset</a>
                    </div>
                </form>
                    ...
                    <table class="table table-striped align-middle">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge <?php echo e($user->status === 'Active' ? 'bg-success' : 'bg-secondary'); ?>">
                                            <?php echo e($user->status ?? 'Unknown'); ?>

                                        </span>
                                    </td>
                                    <td><?php echo e($user->date_created ?? '—'); ?></td>
                                    <td>
                                        <button class="btn btn-sm btn-outline-primary" data-bs-toggle="collapse" data-bs-target="#edit-<?php echo e($user->user_id); ?>">
                                            <i class="bi bi-pencil"></i> Edit
                                        </button>
                                        <form action="<?php echo e(route('manageusers_admin.destroy', $user->user_id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Delete this user?');">
                                            <?php echo csrf_field(); ?>
                                ...
                                <tr class="collapse" id="edit-<?php echo e($user->user_id); ?>">
                                    <td colspan="6">
                                        <form class="row g-2 align-items-end" method="POST" action="<?php echo e(route('manageusers_admin.update', $user->user_id)); ?>">
                                            <?php echo csrf_field(); ?>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <select name="status" class="form-select" required>
                                                    <?php $__currentLoopData = ['Active','Inactive']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($status); ?>" <?php if($user->status===$status): echo 'selected'; endif; ?>><?php echo e($status); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                            <div class="col-md-3">
    ...
    <div class="modal fade" id="addUserModal" tabindex="-1" aria-labelledby="addUserModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?php echo e(route('manageusers_admin.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Main Main file\resources\views/manageusers_admin.blade.php ENDPATH**/ ?>