            ...
            <div class="col-md-3">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <h3 class="fw-bold mb-0"><?php echo e($counts['admins'] ?? 0); ?></h3>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <h3 class="fw-bold mb-0"><?php echo e($counts['officials'] ?? 0); ?></h3>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <h3 class="fw-bold mb-0"><?php echo e($counts['residents'] ?? 0); ?></h3>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <h3 class="fw-bold mb-0"><?php echo e($counts['pendingResidents'] ?? 0); ?></h3>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\Users\Gaan's Computer\Documents\Main Main file\resources\views/manageusers_admin.blade.php ENDPATH**/ ?>