...
<body class="d-flex flex-column min-vh-100">
    <nav class="navbar navbar-expand-lg navbar-dark mb-4">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold ms-4" href="<?php echo e(url('/')); ?>">Community e-Portal</a>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-10">
                <div class="card signup-card mb-5">
                    ...
                    <!-- Sign Up Form -->
                    <form method="POST" action="<?php echo e(route('signup.process')); ?>" id="signupForm" class="needs-validation" novalidate>
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <div class="input-with-icon">
                                        ...
                                        <input type="text" 
                                               class="form-control <?php echo e($errors->has('first_name') ? 'is-invalid error-border' : ''); ?>" 
                                               id="first_name" 
                                               name="first_name" 
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-with-icon">
                                        <i class="bi bi-person input-icon"></i>
                                        <input type="text" 
                                               class="form-control <?php echo e($errors->has('middle_name') ? 'is-invalid error-border' : ''); ?>" 
                                               id="middle_name" 
                                               name="middle_name" 
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-with-icon">
                                        <i class="bi bi-person input-icon"></i>
                                        <input type="text" 
                                               class="form-control <?php echo e($errors->has('last_name') ? 'is-invalid error-border' : ''); ?>" 
                                               id="last_name" 
                                               name="last_name" 
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-with-icon">
                                        ...
                                        <input type="email" 
                                               class="form-control <?php echo e($errors->has('email') ? 'is-invalid error-border' : ''); ?>" 
                                               id="email" 
                                               name="email" 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-with-icon">
                                        ...
                                        <input type="tel" 
                                               class="form-control <?php echo e($errors->has('contact_number') ? 'is-invalid error-border' : ''); ?>" 
                                               id="contact_number" 
                                               name="contact_number" 
                        ...
                        <div class="form-section">
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select <?php echo e($errors->has('sex') ? 'is-invalid error-border' : ''); ?>" id="sex" name="sex" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" 
                                           class="form-control <?php echo e($errors->has('birth_date') ? 'is-invalid error-border' : ''); ?>" 
                                           id="birth_date" 
                                           name="birth_date" 
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-with-icon">
                                        ...
                                        <input type="text" 
                                               class="form-control <?php echo e($errors->has('address') ? 'is-invalid error-border' : ''); ?>" 
                                               id="address" 
                                               name="address" 
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-with-icon">
                                        ...
                                        <input type="password" 
                                               class="form-control <?php echo e($errors->has('password') ? 'is-invalid error-border' : ''); ?>" 
                                               id="password" 
                                               name="password" 
                                               required
                                               minlength="8"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-with-icon">
                                        ...
                                        <input type="password" 
                                               class="form-control <?php echo e($errors->has('password_confirmation') ? 'is-invalid error-border' : ''); ?>" 
                        ...
                        <div class="form-section">
                            <div class="mb-4">
                                <div class="form-check">
                                    <input class="form-check-input <?php echo e($errors->has('terms') ? 'is-invalid error-border' : ''); ?>" 
                                           type="checkbox" 
                                           id="terms" 
                                           name="terms"
                    ...
                    <div class="card-footer text-center py-4 bg-light">
                        <p class="mb-0">
                            ...
                            <a href="<?php echo e(url('login?role=Resident')); ?>" class="text-decoration-none fw-semibold">
...
</html><?php /**PATH C:\Users\Gaan's Computer\Documents\Main Main file\resources\views/signup.blade.php ENDPATH**/ ?>