    ...
    <nav class="navbar navbar-expand-lg navbar-dark mb-4">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark">
                            <li><a class="dropdown-item active" href="<?php echo e(url('transparency_records')); ?>">Transparency Reports</a></li>
        ...
        <div class="card mt-4 mb-4">
            <div class="card-body">
                ...
                <form id="addReportForm" method="POST" action="<?php echo e(route('transparency_records.store')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                    ...
                    <table class="table table-hover mt-3">
                        ...
                        <tbody>
                            <tr v-for="report in reports" :key="report.report_id">
                                <td><strong><?php echo e(""); ?><span v-text="report.title"></span></strong></td>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-link btn-sm text-danger p-0 ms-3" type="button" @click="deleteReport(report.report_id)">
...
</html><?php /**PATH C:\Users\Gaan's Computer\Documents\Main Main file\resources\views/transparency_records.blade.php ENDPATH**/ ?>