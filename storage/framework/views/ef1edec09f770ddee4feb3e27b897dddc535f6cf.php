        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="<?php echo e(url('system_settings')); ?>">System Settings</a></li>
            ...
            <div class="col-md-4">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <h3 class="fw-bold mb-0"><?php echo e($settingsStats['totalAdmins'] ?? 0); ?></h3>
                        <small class="text-success">Active: <?php echo e($settingsStats['activeAdmins'] ?? 0); ?></small>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        <p class="text-muted small mb-1">Audit logs today</p>
                        <h3 class="fw-bold mb-0"><?php echo e($settingsStats['logsToday'] ?? 0); ?></h3>
                        <small class="text-muted">Recent security activity</small>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <h3 class="fw-bold mb-0 text-warning">Create export</h3>
    ...
    <section class="container mb-5">
        <div class="row g-4">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $adminUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge <?php echo e($admin->status === 'Active' ? 'bg-success' : 'bg-secondary'); ?>"><?php echo e($admin->status); ?></span>
                                            </td>
                                        </tr>
            ...
            <div class="col-lg-6">
                <div class="card shadow-sm h-100">
                    <div class="card-header bg-white border-0">
                        <h5 class="mb-0 fw-bold"><i class="bi bi-journal-text me-2"></i>Recent Audit Logs</h5>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $auditLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($log->timestamps); ?></td>
                                            <td><?php echo e($log->id_address); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        ...
                        <small class="text-muted d-block mt-2">Use database export to archive full log history.</small>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="card border-primary h-100">
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(route('manageusers_admin')); ?>" class="btn btn-sm btn-primary">Manage access</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
...
</html><?php /**PATH C:\Users\Gaan's Computer\Documents\Main Main file\resources\views/system_settings.blade.php ENDPATH**/ ?>