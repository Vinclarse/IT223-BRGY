        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="d-flex ms-2">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(url('profile_guest')); ?>">
                            <i class="bi bi-person-circle fs-2 person" style="color: rgb(115, 115, 225);"></i>
                        </a>
                    <?php endif; ?>
                </div>
            ...
            <div class="col-12 col-md-8 col-lg-6">
                <div class="card shadow">
                    ...
                    <div class="card-body p-4">
                        <a href="<?php echo e(url('profile_guest')); ?>" class="card-link mb-4">
                        ...
                        <p class="mt-3 text-center text-secondary" id="signupPrompt">
                            ...
                            <a href="<?php echo e(url('signup')); ?>" class="link-primary">Sign Up</a>
                        </p>
...
<?php /**PATH C:\Users\Gaan's Computer\Documents\Main Main file\resources\views/login.blade.php ENDPATH**/ ?>