                                    ...
                                    <?php if(isset($residents) && $residents->count()): ?>
                                        <?php $__currentLoopData = $residents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo e(route('residents.show', $r->resident_id)); ?>" title="View"><i class="bi bi-eye text-sm"></i></a>
                                                    <a href="<?php echo e(route('residents.edit', $r->resident_id)); ?>" class="ms-3" title="Edit"><i class="bi bi-pencil text-sm"></i></a>
...
</html><?php /**PATH C:\Main Main file\resources\views/manage_residents.blade.php ENDPATH**/ ?>